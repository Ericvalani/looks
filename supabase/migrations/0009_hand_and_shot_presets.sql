...
insert into public.shot_presets (id, label, prompt_fragment, sort_order) values
  ('espelho', 'Foto no espelho', 'This is a real mirror selfie: she stands back from the mirror at a natural, comfortable distance (about 1.5 to 2.5 meters away) so that most of her body, from head to at least the thighs (ideally full body), is visible in the reflection — she is NOT pressed up close to the mirror and NOT filling the frame with her face. She holds an iPhone 16 Pro Max vertically in one hand with the BACK of the phone (rear camera) facing the mirror to take the photo. In the reflection we see her at that distance holding the phone up, its back/camera toward the mirror, the phone partially in front of her upper chest or face — exactly how people really take full-length mirror selfies. There is visible floor beneath her and room space around and behind her. The screen faces her, not the mirror.', 1),
